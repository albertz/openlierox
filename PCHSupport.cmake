...
MACRO(GET_NATIVE_PRECOMPILED_HEADER _targetName _input)
	...
	if(CMAKE_GENERATOR MATCHES Visual*)
		...
		GET_FILENAME_COMPONENT(_name_abs ${_input} ABSOLUTE)
		SET(_dummy_str "#include <${_name_abs}>")

		SET(${_targetName}_pch ${CMAKE_CURRENT_BINARY_DIR}/${_targetName}_pch.cpp)
		FILE(WRITE ${CMAKE_CURRENT_BINARY_DIR}/${_targetName}_pch.cpp ${_dummy_str})
...
MACRO(ADD_NATIVE_PRECOMPILED_HEADER _targetName _input)
	...
	if(CMAKE_GENERATOR MATCHES Visual*)
		...
		if (CMAKE_GENERATOR MATCHES Xcode)
			...
			SET(newProperties "${oldProps} GCC_PREFIX_HEADER=${_input} GCC_PRECOMPILE_PREFIX_HEADER=YES")

			# This need the Xcode generator patch (2.4.8 ?)
			SET_TARGET_PROPERTIES(${_targetName} PROPERTIES COMPILE_FLAGS "${newProperties}")
