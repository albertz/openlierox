...
class proj_t { public:
	UCString	filename;		// Compiler use (was 64b before)
	int		id;					// File ref use
	...
	int		Colour1[3];
	int		Colour2[3];
	UCString	ImgFilename; // (was 64b before)
	int		Rotating;
	int		RotIncrement;
	int		RotSpeed;
	int		UseAngle;
	...
	int		Hit_UseSound;
	int		Hit_Shake;
	UCString	Hit_SndFilename; // (was 64b before)
	...
	int		Exp_Projectiles;
	int		Exp_UseSound;
    UCString	Exp_SndFilename; // (was 64b before)
	int		Exp_Shake;
	...
	int		Tch_Projectiles;
	int		Tch_UseSound;
    UCString	Tch_SndFilename; // (was 64b before)
	int		Tch_Shake;
