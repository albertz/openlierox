...
void	Menu_Player_AddPlayer(const tString& sName, Uint8 r, Uint8 g, Uint8 b);
...
int		Menu_MapEd_OkSave(const tString& szFilename);
...
void	Menu_Net_LANJoinServer(const tString& sAddress, const tString& sName);
void    Menu_Net_LanShowServer(const tString& szAddress);


// Net::Joining menu
int		Menu_Net_JoinInitialize(const tString& sAddress);
...
void	Menu_Net_FavouritesJoinServer(const tString& sAddress, const tString& sName);
void	Menu_Net_FavouritesShowServer(const tString& szAddress);
void	Menu_Net_RenameServer(const tString& szName);
...
int		Menu_Net_JoinConnectionInitialize(const tString& sAddress);
...
tString	Menu_Net_JoinLobbyGetText(void);
