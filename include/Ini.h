...
public:		
	...
	//    String Access
	//------------------------------------------------------------	
	DWORD GetStr(LPCTSTR lpSection, LPCTSTR lpKey, LPTSTR lpBuffer, DWORD dwBufSize, LPCTSTR lpDefault = NULL) const;
#ifdef __DONTINCLUDE_H__
	CString GetStr(LPCTSTR lpSection, LPCTSTR lpKey, LPCTSTR lpDefault = NULL) const;
#endif
