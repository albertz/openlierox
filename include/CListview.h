...
public:
	...
	void	AddColumn(const UCString& sText, int iWidth);
	void	AddItem(const UCString& sIndex, int iIndex, int iColour);
	void	AddSubitem(int iType, const UCString& sText, SDL_Surface *img);
	...
	lv_item_t* getItem(const UCString& name);
