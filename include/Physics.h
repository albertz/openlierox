...
// ------------
	...
	virtual void simulateWorm(CWorm* worm, CWorm *worms, bool local, AbsTime simulationTime) = 0;
	virtual void simulateWormWeapon(TimeDiff dt, CWorm* worm) = 0;
	virtual void simulateProjectiles(Iterator<CProjectile*>::Ref projs, AbsTime currentTime) = 0;
