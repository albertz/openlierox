...
#ifndef __MEDIAPLAYER_H__DEPRECATED_GUI__
#define __MEDIAPLAYER_H__DEPRECATED_GUI__
...
// Marquee
const int MARQUEE_STEP = 2;
const float MARQUEE_TIME = 0.10f;
const float MARQUEE_ENDWAIT = 0.2f;
...
#endif  //  __MEDAIPLAYER_H__DEPRECATED_GUI__
