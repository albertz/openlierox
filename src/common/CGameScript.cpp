...
int CGameScript::Save(const tString& filename)
{
	FILE *fp;
	int n;
...
int CGameScript::Load(const tString& dir)
{
...
///////////////////
// Load an image
SDL_Surface *CGameScript::LoadGSImage(const tString& dir, const tString& filename)
{
...
///////////////////
// Load a sample
SoundSample* CGameScript::LoadGSSample(const tString& dir, const tString& filename)
{
...
weapon_t *CGameScript::FindWeapon(const tString& name)
{
	int n;
...
bool CGameScript::weaponExists(const tString& szName)
{
    // Go through each weapon
	weapon_t *wpn = Weapons;
...
void CGameScript::writeString(const tString& szString, FILE *fp)
{
    if(szString == "") return;
...
tString CGameScript::readString(FILE *fp)
{
...
int CGameScript::CheckFile(const tString& dir, tString& name)
{
	name = "";
	tString filename = dir + "/script.lgs";
...
tString CGameScript::getError(int code)
{
	tString text = "Undefined error";
