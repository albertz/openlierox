...
Feature(77, "RopeCanAttachWorm", "Rope can attach worm", "when false, you cannot attach worms with your rope", true, true, OLXBetaVersion(0,59,10), GIG_Advanced, ALT_VeryAdvanced, false, false),
	...
	Feature(160, "WeaponSlotsNum", "Weapon slots number", "amount of weapon slots each worm has", 5, 5, OLXBetaVersion(0,59,10)),
	...
	Feature(162, "WeaponCombos",			"Weapon combos",	"Enable/disable weapon combos, i.e. fast changing of weapons and shooting at the same time",
