...
Feature(77, "RopeCanAttachWorm", "Rope can attach worm", "when false, you cannot attach worms with your rope", false, false, OLXBetaVersion(0,59,10), GIG_Advanced, ALT_VeryAdvanced, false, false),
	...
	Feature(160, "DisableWpnsWhenEmpty",	"Disable weapons when empty", "When a weapon got uncharged, it got disabled and you have to catch a bonus (be sure that you have bonuses activated). This is usefull in games like Race.",
			false,	false,			OLXBetaVersion(7) /* it needs wpninfo packet which is there since beta7 */,		GIG_Weapons, ALT_VeryAdvanced,	true),
	Feature(161, "WeaponCombos",			"Weapon combos",	"Enable/disable weapon combos, i.e. fast changing of weapons and shooting at the same time",
			true,	true,			OLXBetaVersion(0,58,10),	GIG_Weapons, ALT_Advanced,	false, false),
	Feature(162, "InfiniteMap",			"Infinite map",			"Map has no borders and is tiled together",
			false,	false,			OLXBetaVersion(0,58,1),		GIG_Other,	ALT_Advanced,	false),
	Feature(163, "WormFriction",			"Worm Friction",		"Friction coefficient for worms (0 = disabled)",
			0.0f, 0.0f,				OLXBetaVersion(0,58,1),		GIG_Other,	ALT_VeryAdvanced,	0.0f, 2.0f,	false),
	Feature(164, "WormGroundFriction",	"Worm Ground Friction",		"Air friction coefficient when worms are on ground (0.1 = default; 1 = stucked; 0 = no friction)",
			0.1f, 0.1f,				OLXBetaVersion(0,58,9),		GIG_Other,	ALT_VeryAdvanced,	0.0f, 1.0f,	false),
	Feature(165, "WormGroundStopSpeed",	"Worm Ground Stop Speed",	"Once the worms has this velocity or less (in x-direction), the x-velocity is set to 0",
			5.0f, 5.0f,				OLXBetaVersion(0,59,6),		GIG_Other,	ALT_VeryAdvanced,	0.0f, 10.0f,	false),
	Feature(166, "WormMaxGroundMoveSpeed",	"Worm max ground move speed",		"When moving the worm via left/right, this is the maximum on ground (default: 30)",
			30.0f, 30.0f,			OLXBetaVersion(0,59,6),		GIG_Other,	ALT_VeryAdvanced,	0.1f, 200.0f,	false, false),
	Feature(167, "WormMaxAirMoveSpeed",		"Worm max air move speed",		"When moving the worm via left/right, this is the maximum in air (default: 30)",
			30.0f, 30.0f,			OLXBetaVersion(0,59,6),		GIG_Other,	ALT_VeryAdvanced,	0.1f, 200.0f,	false, false),
	Feature(168, "GusanosWormPhysics",	"Gusanos worm physics",		"Worm moving is done with Gusanos worm physics",
			false, false,			OLXBetaVersion(0,59,6),		GIG_Other,	ALT_VeryAdvanced,	false, false),

	Feature(170, "ProjFriction",			"Projectile Friction",		"Air friction coefficient for projectiles (0 = disabled)",
			0.0f, 0.0f,				OLXBetaVersion(0,58,1),		GIG_Weapons,	ALT_VeryAdvanced,	0.0f, 2.0f,	false),
	Feature(171, "ProjRelativeVel",		"Relative projectile velocity",	"Worm velocity is added to projectile velocity when you shoot",
			true, true,				Version(),					GIG_Weapons,	ALT_VeryAdvanced,	true, true),
	Feature(172, "ProjGravityFactor",	"Projectile gravity factor",	"Projectile gravity factor",
			1.0f, 1.0f,				OLXBetaVersion(0,59,6),		GIG_Weapons,	ALT_VeryAdvanced,	-10.0f, 10.0f, false, false),
	Feature(173, "LX56WallShooting",		"LX56 wall shooting",		"LX56-like wall shooting enabled. To disable this, check also the option ShootSpawnDistance",
			true, true,				OLXBetaVersion(0,59,6),		GIG_Weapons,	ALT_VeryAdvanced,	false, false),
	Feature(174, "ShootSpawnDistance",	"Shoot spawn distance",		"Projectile shoot spawn distance",
			8.0f, 8.0f,				OLXBetaVersion(0,59,6),		GIG_Weapons,	ALT_VeryAdvanced,	0.0f, 20.0f, false, false),

	Feature(180, "TeamScoreLimit",		"Team Score limit",		"Team score limit",
			-1, -1,					OLXBetaVersion(0,58,1),		GIG_General, ALT_Basic,	-1, 100,	true, true, true),

	Feature(190, "SizeFactor",			"Size factor",			"The size of everything in game will be changed by this factor (i.e. made bigger or smaller)",
	...
	Feature(200, "CTF_AllowRopeForCarrier", "Allow rope for carrier", "The worm who is holding the flag can use ninja rope",
			true, true,				OLXBetaVersion(0,58,1),		GIG_CaptureTheFlag, ALT_Basic, true),
	Feature(201, "CTF_SpeedFactorForCarrier", "Speed factor for carrier", "Changes the carrier speed by this factor. Perhaps you want to make the carrier slower so you can more easily get the flag again.",
			1.0f, 1.0f,				OLXBetaVersion(0,58,1),		GIG_CaptureTheFlag, ALT_Basic, 0.1f, 3.0f, true),

	Feature(210, "Race_Rounds", "Rounds", "Amount of rounds",
			5,5,					Version(),				GIG_Race,	ALT_Basic,	-1,		100,	true,	true),
	Feature(211, "Race_AllowWeapons", "Allow weapons", "If disabled, you cannot shoot",
			false,	false,			Version(),				GIG_Race,	ALT_Advanced,	false),
	Feature(212, "Race_CheckPointRadius", "Checkpoint radius", "The radius of the checkpoints (bigger value makes race easier)",
