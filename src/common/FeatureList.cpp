...
Feature( "LoadingTime", "Loading time", "Loading time of weapons, in percent",100,100, Version(), GIG_General, ALT_Basic, 0, 500, false,false, true),
	...
	Feature( "LevelName", "Map", "Map", LevelInfo(), LevelInfo::ByPath("Dirt Level.lxl"), Version(), GIG_General, ALT_Basic, false, false ),
Feature( "GameType", "Game mode", "Game mode is the type of game you want to play (DM, TDM, CTF, etc.)", GameModeInfo(), GameModeInfo(), Version(), GIG_General, ALT_Basic, false, false ),
	Feature( "ModName", "Mod", "Mod", ModInfo(), ModInfo::ByPath("Classic"), Version(), GIG_General, ALT_Basic, false, false ),
...
Feature( "LX56PhysicsFPS", "LX56 physics FPS", "Simulation frames per second for LX56 physics", 84, 84, OLXBetaVersion(0,59,9), GIG_Advanced, ALT_VeryAdvanced, 1, 200, false, true /* we do a custom check for compatibility */ ),
Feature( "ForceSameLX56PhysicsFPS", "Force same LX56 physics FPS", "If enabled (default), the physics simulation will be everywhere the same by using the same FPS. If disabled, it can be different everywhere, like it was in original LX56.", true, true, OLXBetaVersion(0,59,9), GIG_Advanced, ALT_VeryAdvanced, false, true ),
...
Feature( "ForceLX56Aim", "Force LX56 aim", "Force the aim speed/acceleration to be everywhere like LX56", false, false, OLXBetaVersion(0,59,9), GIG_Advanced, ALT_VeryAdvanced, false, true /* we do a custom check for compatibility */ ),
...
Feature( "RopeCanAttachWorm", "Rope can attach worm", "when false, you cannot attach worms with your rope", false, false, OLXBetaVersion(0,59,10), GIG_Advanced, ALT_VeryAdvanced, false, false),
	...
	Feature("WormGroundStopSpeed",	"Worm Ground Stop Speed",	"Once the worms has this velocity or less (in x-direction), the x-velocity is set to 0",
			5.0f, 5.0f,				OLXBetaVersion(0,59,6),		GIG_Other,	ALT_VeryAdvanced,	0.0f, 10.0f,	false),
	Feature("WormMaxGroundMoveSpeed",	"Worm max ground move speed",		"When moving the worm via left/right, this is the maximum on ground (default: 30)",
