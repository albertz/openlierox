...
bool Server::Net_cbZoidRequest( Net_ConnID _id, zU8 _requested_level, Net_BitStream &_reason)
{
...
void Server::Net_cbZoidResult(Net_ConnID _id, eNet_ZoidResult _result, zU8 _new_level, Net_BitStream &_reason)
{
  char tmpstr[255];
	// failed
...
/*
  ...
  // this will create the Net_Node and register it with us (we are a Net_Control)
...
void Client::Net_cbZoidResult(Net_ConnID _id, eNet_ZoidResult _result, zU8 _new_level, Net_BitStream &_reason)
{
