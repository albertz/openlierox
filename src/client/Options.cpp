...
bool GameOptions::Init() {
	...
	CScriptableVars::RegisterVars("GameOptions")
		...
		( tLXOptions->bAimFrictionLikeLX56, "Game.AimFrictionLikeLX56", false, "Aim friction like LX56", "aim speed friction behaves like LX56", GIG_Other, ALT_OnlyViaConfig )
