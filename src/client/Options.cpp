...
bool GameOptions::Init() {
	...
	CScriptableVars::RegisterVars("GameOptions.GameInfo")
		...
		( tLXOptions->tGameInfo.iWeaponSelectionMaxTime, "WeaponSelectionMaxTime", 60, "Weapon selection max time", "Max time to allow players to select weapons, in seconds", GIG_Weapons )
		;
