...
IF (BREAKPAD)
	...
	IF(APPLE)
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/DumpSyms_mac.mm ${ALL_SRCS})
	ELSE(APPLE)
	...
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/minidump_file_writer.cc ${ALL_SRCS})
	IF(APPLE)
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/mac/handler/breakpad_exc_server.c ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/mac/handler/breakpad_nlist_64.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/mac/handler/dynamic_images.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/mac/handler/exception_handler.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/mac/handler/minidump_generator.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/mac/handler/protected_memory_allocator.cc ${ALL_SRCS})
	ELSE(APPLE) 
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/linux/handler/exception_handler.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/linux/handler/linux_thread.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/linux/minidump_writer/linux_dumper.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/client/linux/minidump_writer/minidump_writer.cc ${ALL_SRCS})
	ENDIF(APPLE)

	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/convert_UTF.c ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/md5.c ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/string_conversion.cc ${ALL_SRCS})
	IF(APPLE)
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/dump_syms.mm ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/file_id.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/MachIPC.mm ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/macho_id.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/macho_utilities.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/macho_walker.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/SimpleStringDictionary.mm ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/mac/string_utilities.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/dwarf/functioninfo.cc ${ALL_SRCS})
	ELSE(APPLE)
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/linux/file_id.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/linux/guid_creator.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/linux/dump_symbols.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/linux/module.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/linux/stabs_reader.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/linux/dump_dwarf.cc ${ALL_SRCS})
	ENDIF(APPLE)
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/dwarf/bytereader.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/dwarf/dwarf2diehandler.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/common/dwarf/dwarf2reader.cc ${ALL_SRCS})

	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/basic_code_modules.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/basic_source_line_resolver.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/call_stack.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/logging.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/minidump.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/minidump_processor.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/pathname_stripper.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/process_state.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/simple_symbol_supplier.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/stackwalker_amd64.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/stackwalker_ppc.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/stackwalker_sparc.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/stackwalker_x86.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/libs/breakpad/src/processor/stackwalker.cc ${ALL_SRCS})
...
IF(APPLE)
	...
	link_directories(${OLXROOTDIR}/build/Xcode/Ogg.framework)
	link_directories(${OLXROOTDIR}/build/Xcode/Vorbis.framework)
