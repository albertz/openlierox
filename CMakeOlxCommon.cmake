...
IF (BREAKPAD)
	...
	IF(APPLE)
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/client/mac/handler/breakpad_exc_server.c ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/client/mac/handler/breakpad_nlist_64.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/client/mac/handler/dynamic_images.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/client/mac/handler/exception_handler.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/client/mac/handler/minidump_generator.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/client/mac/handler/protected_memory_allocator.cc ${ALL_SRCS})
	ELSE(APPLE) 
	...
	IF(APPLE)
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/dump_syms.mm ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/file_id.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/MachIPC.mm ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/macho_id.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/macho_utilities.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/macho_walker.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/SimpleStringDictionary.mm ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/mac/string_utilities.cc ${ALL_SRCS})
	SET(ALL_SRCS ${OLXROOTDIR}/src/breakpad/external/src/common/dwarf/functioninfo.cc ${ALL_SRCS})
	ELSE(APPLE)
